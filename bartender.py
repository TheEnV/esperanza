...
class Bartender:
    """Buy a drink at the bar with Esperanza's economy currency"""
    ...
    async def buy(self, ctx, amount : int, drink):
        """Buy a drink with currency from Esperanza's economy"""
    ...
    async def register(self, ctx):
        """Opens the bar and registers the bot into Esperanza's bank."""
